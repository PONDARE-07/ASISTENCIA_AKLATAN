...
<div class = "navbar-header">
					<img src = "images/bsulogo.png" width = "50px" height = "50px" />
					<h4 class = "navbar-text navbar-right">Welcome Administrator</h4>
				</div>
				<br>
				<br>
...
<div>
	<a href="https://dione.batstate-u.edu.ph/student/#/">
    <p align="right">
	<form action="/action_page.php">
  <input type="file" id="myFile" name="filename" style="float: right;">
